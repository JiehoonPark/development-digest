...
## 평가 기준
- relevance (0-100): **프론트엔드 개발자에게** 얼마나 유용한지 평가
  - frontend/typescript 콘텐츠: 내용의 깊이와 실무 적용 가능성 기준으로 평가
  - backend/devops/ai 등 다른 도메인: 프론트엔드 실무에 직접 영향을 줄 때만 70 이상
    (예: Node.js 런타임, 웹 표준/브라우저, 번들러 등 FE 도구체인, AI 코딩 도구)
  - 특정 도메인과 무관한 일반 기술 교양·시사(general)는 40 이하
