...
> [!info] 원문
> [Introduction to Nintendo DS Programming](https://www.patater.com/files/projects/manual/manual.html) · Hacker News (Top)

## 핵심 개념

> [!abstract]
> Nintendo DS 게임 개발을 시작하려는 사람들을 위한 입문 가이드로, C/C++ 기초 지식을 가진 개발자를 대상으로 홈브류 커뮤니티의 배경, 개발 환경 설정, 배경 표시, 스프라이트 사용 등을 다룬다. 저자는 간단한 게임 'Orange Spaceship'을 만드는 실습을 통해 기본적인 게임 프로그래밍 기법을 설명한다.
...
- [원문 링크](https://www.patater.com/files/projects/manual/manual.html)
- via Hacker News (Top)
- engagement: 202
