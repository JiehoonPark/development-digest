---
title: "Backblaze가 OneDrive와 Dropbox 폴더 백업을 중단했습니다"
tags: [dev-digest, hot]
type: study
tech:
  - frontend
...
> [!info] 원문
> [Backblaze has stopped backing up OneDrive and Dropbox folders and maybe others](https://rareese.com/posts/backblaze/) · Hacker News (Top)

## 핵심 개념

> [!abstract]
> Backblaze가 사용자에게 공지 없이 OneDrive, Dropbox 등 클라우드 저장소 폴더의 백업을 중단했습니다. 사용자는 10년간 신뢰했던 서비스가 핵심 기능을 제거했다며 불만을 표시하고 있습니다.
...
문제의 신호는 2025년에 처음 나타났어요. 실수로 GitHub에 `push -f`를 날려 5년 된 저장소의 git 히스토리를 날려먹었거든요. 데이터 자체는 손실되지 않았지만, 변경 로그는 사라졌어요. 문제없다고 생각했어요. Backblaze에서 복원하면 되니까요. 하지만 그럴 리가요. 어느 시점부터 Backblaze는 .git 폴더를 무시하기 시작했던 겁니다.
...
- [원문 링크](https://rareese.com/posts/backblaze/)
- via Hacker News (Top)
- engagement: 901
